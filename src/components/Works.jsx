...
const PROJECTS_STATE = [
    {
        id: 1,
        title: 'Gallery',
        description: "Gallery of paintings of great people of past",
    ...
    },
    {
        id: 5,
        title: 'Todo list',
        description: 'A todo list is a simple yet effective tool for organizing tasks and managing time. It serves as a written reminder of what needs to be done, helping individuals prioritize and track their responsibilities.',
